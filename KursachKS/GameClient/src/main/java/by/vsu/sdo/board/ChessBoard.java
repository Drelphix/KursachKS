...
public class ChessBoard extends JFrame implements MouseListener, MouseMotionListener
{
    ...
    public ChessBoard()
    {
        ...
        Color black = new Color(152, 89, 46);
        Color white = new Color(233, 216, 159);
        ...
        for (int i = 0; i < 64; i++)
        {
            ...
            int row = (i / 8) % 2;
            if (row == 0)
                square.setBackground( i % 2 == 0 ? white : black );
            else
                square.setBackground( i % 2 == 0 ? black : white );
        }



        JLabel piece = new JLabel( new ImageIcon("1.png") );
        JPanel panel = (JPanel)chessBoard.getComponent( 40 );
        panel.add( piece );
        piece = new JLabel( new ImageIcon("1.png") );
        panel = (JPanel)chessBoard.getComponent( 42 );
        panel.add( piece );
        piece = new JLabel( new ImageIcon("1.png") );
        panel = (JPanel)chessBoard.getComponent( 44 );
        panel.add( piece );
        piece = new JLabel( new ImageIcon("1.png") );
        panel = (JPanel)chessBoard.getComponent( 46 );
        panel.add( piece );
        piece = new JLabel( new ImageIcon("1.png") );
        ...
        panel.add( piece );
        piece = new JLabel( new ImageIcon("2.png") );
        panel = (JPanel)chessBoard.getComponent( 17 );
        panel.add( piece );
        piece = new JLabel( new ImageIcon("2.png") );
        panel = (JPanel)chessBoard.getComponent( 19 );
        panel.add( piece );
        piece = new JLabel( new ImageIcon("2.png") );
        panel = (JPanel)chessBoard.getComponent( 21 );
        panel.add( piece );
        piece = new JLabel( new ImageIcon("2.png") );
        panel = (JPanel)chessBoard.getComponent( 23 );
        panel.add( piece );
    }
